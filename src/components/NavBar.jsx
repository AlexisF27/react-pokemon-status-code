...
function NavBar() {
  return (
    <header id="header">
      ...
      <Typography variant="h4" style={{ fontFamily: 'Roboto' }} className="roboto-font normal-weight description">Dogs for every HyperText Transfer Protocol response status code.</Typography>
    </header>
  );
}
